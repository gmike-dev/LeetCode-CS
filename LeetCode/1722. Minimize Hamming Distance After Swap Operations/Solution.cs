...
public class Solution
{
    public int MinimumHammingDistance(int[] source, int[] target, int[][] allowedSwaps)
    {
        ...
        Span<bool> canSwap = stackalloc bool[n];
...
public class SolutionTests
{
    ...
    {
        new Solution().MinimumHammingDistance(source.Array(), target.Array(), allowedSwaps.Array2()).Should()
            .Be(expected);
    }
    ...
    {
        new Solution().MinimumHammingDistance(source.Array(), target.Array(), allowedSwaps.Array2())
            .Should()
            .Be(expected);
    }
