...
public class BitmaskSolutionTests
{
    ...
    public void Test16()
    {
        new BitmaskSolution().SubsetsWithDup(new[] { 1, 9, 8, 3, -1, 0 })
            ...
            .BeEquivalentTo(new[]
            {
                new int[0], new[] { -1 }, new[] { -1, 0 }, new[] { -1, 0, 1 }, new[] { -1, 0, 1, 3 },
                new[] { -1, 0, 1, 3, 8 },
