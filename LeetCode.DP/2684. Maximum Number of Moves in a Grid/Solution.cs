...
public class Solution
{
  public int MaxMoves(int[][] grid)
  {
    ...
    return Enumerable.Range(0, m).Max(i => dp[i][0]);
  }
}
...
public class SolutionTests
{
  ...
  public void Test1()
  {
    new Solution().MaxMoves([[2, 4, 3, 5], [5, 4, 9, 3], [3, 4, 2, 11], [10, 9, 13, 15]]).Should().Be(3);
  }

  [Test]
  public void Test2()
  {
    new Solution().MaxMoves([[3, 2, 4], [2, 1, 9], [1, 1, 7]]).Should().Be(0);
  }

  [Test]
  public void Test3()
  {
    new Solution().MaxMoves([
