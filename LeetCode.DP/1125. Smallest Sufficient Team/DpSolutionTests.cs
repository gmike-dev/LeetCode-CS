...
public class DpSolutionTests
{
    ...
    public void Test1()
    {
        new DpSolution().SmallestSufficientTeam(
    ...
    public void Test6()
    {
        new DpSolution().SmallestSufficientTeam(
                ...
                new IList<string>[]
                {
                    ...
                    new[] { "7" },
                    new[] { "8" }, new[] { "9" }, new[] { "10" }, new[] { "11" }, new[] { "12" }, new[] { "13" },
                    new[] { "14" },
                    new[] { "15" }, new[] { "16" },
                    new[] { "1" }, new[] { "2" }, new[] { "3" }, new[] { "4" }, new[] { "5" }, new[] { "6" },
                    new[] { "7" },
    ...
    public void Test36()
    {
        new DpSolution().SmallestSufficientTeam(
                new[]
                {
                    "hfkbcrslcdjq", "jmhobexvmmlyyzk", "fjubadocdwaygs", "peaqbonzgl", "brgjopmm", "x", "mf",
                    "pcfpppaxsxtpixd",
                ...
                new IList<string>[]
                {
                    ...
                    new[] { "fjubadocdwaygs" }, new[] { "x", "a", "ulqocaijhezwfr", "zshbwqdhx" },
                    new[] { "peaqbonzgl" },
                    new[] { "pcfpppaxsxtpixd", "ulqocaijhezwfr", "hyxnrujrqykzhizm" },
                    new[] { "a", "ulqocaijhezwfr", "hyxnrujrqykzhizm" }, new[] { "a", "rahimgtlopffbwdg" },
                    new[] { "zshbwqdhx" },
                    ...
                    new[] { "zezdb", "hyxnrujrqykzhizm" }, new[] { "ccwfthnjt", "a" },
                    new[] { "fjubadocdwaygs", "zezdb", "a" },
                    ...
                    new[] { "pcfpppaxsxtpixd", "zshbwqdhx" },
                    new[] { "peaqbonzgl", "brgjopmm", "pcfpppaxsxtpixd", "a" },
