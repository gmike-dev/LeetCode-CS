...
public class AvxSolution
{
  ...
  private static unsafe int FastXorArray(int[] a)
  {
    if (!Avx2.IsSupported)
...
public class AvxSolutionTests
{
  ...
  {
    new AvxSolution().XorAllNums(nums1, nums2).Should().Be(expected);
  }
}
